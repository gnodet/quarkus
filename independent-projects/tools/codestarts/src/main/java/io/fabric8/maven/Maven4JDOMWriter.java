...
final class Maven4JDOMWriter {
    ...
    public Maven4JDOMWriter(String indentation) {
    ...
    public void write(Model project, Document document, Writer writer, XMLOutputter xmlOutputter) throws java.io.IOException {
        updateModel(project, Maven4JDOMWriter.Counter.initialCounter(), document.getRootElement());
     ...
     */
    private void findAndReplaceProperties(Maven4JDOMWriter.Counter counter, Element parent, String name, Properties props) {
        ...
        if (shouldExist) {
            ...
            Maven4JDOMWriter.Counter innerCounter = counter.newNextDepthLevelCounter();
            while (it.hasNext()) {
     ...
     */
    private void findAndReplaceSimpleElement(Maven4JDOMWriter.Counter counter, Element parent, String name, String text,
            String defaultValue) {
     ...
     */
    private void findAndReplaceSimpleLists(Maven4JDOMWriter.Counter counter, Element parent, Collection<String> list,
        ...
        if (shouldExist) {
            ...
            Maven4JDOMWriter.Counter innerCount = counter.newNextDepthLevelCounter();
            while (it.hasNext()) {
     ...
     * @param parent The parent element
     */
    private void findAndReplaceXpp3DOM(Maven4JDOMWriter.Counter counter, Element parent, String name, Xpp3Dom dom) {
     ...
     */
    private void insertAtPreferredLocation(Element parent, Element child, Maven4JDOMWriter.Counter counter) {
        int contentIndex = 0;
     ...
     */
    private void iterateContributor(Maven4JDOMWriter.Counter counter, Element parent, Collection<Contributor> list) {
        boolean shouldExist = (list != null) && (!list.isEmpty());
     ...
     * @param list The list to iterate
     */
    private void iterateDependency(Maven4JDOMWriter.Counter counter, Element parent, Collection<Dependency> list) {
        boolean shouldExist = (list != null) && (!list.isEmpty());
     ...
     * @param list The list to iterate
     */
    private void iterateDeveloper(Maven4JDOMWriter.Counter counter, Element parent, Collection<Developer> list) {
        boolean shouldExist = (list != null) && (!list.isEmpty());
     ...
     * @param list The list to iterate
     */
    private void iterateExclusion(Maven4JDOMWriter.Counter counter, Element parent, Collection<Exclusion> list) {
        boolean shouldExist = (list != null) && (!list.isEmpty());
     ...
     * @param list The list to iterate
     */
    private void iterateExtension(Maven4JDOMWriter.Counter counter, Element parent, Collection<Extension> list) {
        boolean shouldExist = (list != null) && (!list.isEmpty());
     ...
     * @param list The list to iterate
     */
    private void iterateLicense(Maven4JDOMWriter.Counter counter, Element parent, Collection<License> list) {
        boolean shouldExist = (list != null) && (!list.isEmpty());
     ...
     * @param list The list to iterate
     */
    private void iterateMailingList(Maven4JDOMWriter.Counter counter, Element parent, Collection<MailingList> list) {
        boolean shouldExist = (list != null) && (!list.isEmpty());
     ...
     * @param list The list to iterate
     */
    private void iterateNotifier(Maven4JDOMWriter.Counter counter, Element parent, Collection<Notifier> list) {
        boolean shouldExist = (list != null) && (!list.isEmpty());
     ...
     * @param list The list to iterate
     */
    private void iteratePlugin(Maven4JDOMWriter.Counter counter, Element parent, Collection<Plugin> list) {
        boolean shouldExist = (list != null) && (!list.isEmpty());
     ...
     * @param list The list to iterate
     */
    private void iteratePluginExecution(Maven4JDOMWriter.Counter counter, Element parent, Collection<PluginExecution> list) {
        boolean shouldExist = (list != null) && (!list.isEmpty());
     ...
     * @param list The list to iterate
     */
    private void iterateProfile(Maven4JDOMWriter.Counter counter, Element parent, Collection<Profile> list) {
        boolean shouldExist = (list != null) && (!list.isEmpty());
     ...
     * @param list The list to iterate
     */
    private void iterateReportPlugin(Maven4JDOMWriter.Counter counter, Element parent, Collection<ReportPlugin> list) {
        boolean shouldExist = (list != null) && (!list.isEmpty());
        Element element = updateElement(counter, parent, "plugins", shouldExist);
        if (shouldExist) {
            var it = list.iterator();
     ...
     * @param list The list to iterate
     */
    private void iterateReportSet(Maven4JDOMWriter.Counter counter, Element parent, Collection<ReportSet> list) {
        boolean shouldExist = (list != null) && (!list.isEmpty());
     ...
     */
    private void iterateRepository(Maven4JDOMWriter.Counter counter, Element parent, Collection<Repository> list,
     ...
     * @param childTag The tag of the newProperty element
     */
    private void iterateResource(Maven4JDOMWriter.Counter counter, Element parent, Collection<Resource> list,
            String parentTag, String childTag) {
        boolean shouldExist = (list != null) && (!list.isEmpty());
        Element element = updateElement(counter, parent, parentTag, shouldExist);
        if (shouldExist) {
     ...
     * @param counter The counter
     */
    private void replaceXpp3DOM(final Element parent, final Xpp3Dom parentDom, final Maven4JDOMWriter.Counter counter) {
     ...
     */
    private void updateActivation(Activation value, Maven4JDOMWriter.Counter counter, Element element) {
     ...
     * @param element The parent element
     */
    private void updateActivationFile(ActivationFile value, Maven4JDOMWriter.Counter counter, Element element) {
        boolean shouldExist = value != null;
     ...
     * @param element The parent element
     */
    private void updateActivationOS(ActivationOS value, Maven4JDOMWriter.Counter counter, Element element) {
        boolean shouldExist = value != null;
     ...
     * @param element The parent element
     */
    private void updateActivationProperty(ActivationProperty value, Maven4JDOMWriter.Counter counter, Element element) {
        boolean shouldExist = value != null;
     ...
     * @param element The parent element
     */
    private void updateBuild(Build value, Maven4JDOMWriter.Counter counter, Element element) {
        boolean shouldExist = value != null;
     ...
     * @param element The parent element
     */
    private void updateBuildBase(BuildBase value, Maven4JDOMWriter.Counter counter, Element element) {
        boolean shouldExist = value != null;
        Element root = updateElement(counter, element, "build", shouldExist);
        if (shouldExist) {
            Maven4JDOMWriter.Counter innerCount = counter.newNextDepthLevelCounter();
     ...
     * @param element The parent element
     */
    private void updateCiManagement(CiManagement value, Maven4JDOMWriter.Counter counter, Element element) {
        boolean shouldExist = value != null;
     ...
     */
    private void updateContributor(Contributor value, Maven4JDOMWriter.Counter counter, Element root) {
        Maven4JDOMWriter.Counter innerCount = counter.newNextDepthLevelCounter();
        findAndReplaceSimpleElement(innerCount, root, "name", value.getName(), null);
     ...
     * @param counter The counter
     */
    private void updateDependency(Dependency value, Maven4JDOMWriter.Counter counter, Element root) {
        Maven4JDOMWriter.Counter innerCount = counter.newNextDepthLevelCounter();
     ...
     * @param element The parent element
     */
    private void updateDependencyManagement(DependencyManagement value, Maven4JDOMWriter.Counter counter,
            Element element) {
        boolean shouldExist = value != null;
     ...
     * @param element The parent element
     */
    private void updateDeploymentRepository(DeploymentRepository value, String xmlTag, Maven4JDOMWriter.Counter counter,
            Element element) {
        boolean shouldExist = value != null;
     ...
     * @param root The parent element
     */
    private void updateDeveloper(Developer value, Maven4JDOMWriter.Counter counter, Element root) {
        Maven4JDOMWriter.Counter innerCount = counter.newNextDepthLevelCounter();
        findAndReplaceSimpleElement(innerCount, root, "id", value.getId(), null);
        findAndReplaceSimpleElement(innerCount, root, "name", value.getName(), null);
        findAndReplaceSimpleElement(innerCount, root, "email", value.getEmail(), null);
     ...
     * @param element The parent element
     */
    private void updateDistributionManagement(DistributionManagement value, Maven4JDOMWriter.Counter counter,
            Element element) {
        boolean shouldExist = value != null;
     ...
     */
    private Element updateElement(Maven4JDOMWriter.Counter counter, Element parent, String name, boolean shouldExist) {
        Element element = parent.getChild(name, parent.getNamespace());
     ...
     * @param root The parent element
     */
    private void updateExclusion(Exclusion value, Maven4JDOMWriter.Counter counter, Element root) {
        Maven4JDOMWriter.Counter innerCount = counter.newNextDepthLevelCounter();
        findAndReplaceSimpleElement(innerCount, root, "groupId", value.getGroupId(), null);
        findAndReplaceSimpleElement(innerCount, root, "artifactId", value.getArtifactId(), null);
    }
     ...
     * @param root The parent element
     */
    private void updateExtension(Extension value, Maven4JDOMWriter.Counter counter, Element root) {
        Maven4JDOMWriter.Counter innerCount = counter.newNextDepthLevelCounter();
        findAndReplaceSimpleElement(innerCount, root, "groupId", value.getGroupId(), null);
        findAndReplaceSimpleElement(innerCount, root, "artifactId", value.getArtifactId(), null);
        findAndReplaceSimpleElement(innerCount, root, "version", value.getVersion(), null);
     ...
     * @param element The parent element
     */
    private void updateIssueManagement(IssueManagement value, Maven4JDOMWriter.Counter counter, Element element) {
        boolean shouldExist = value != null;
     ...
     * @param root The parent element
     */
    private void updateLicense(License value, Maven4JDOMWriter.Counter counter, Element root) {
        Maven4JDOMWriter.Counter innerCount = counter.newNextDepthLevelCounter();
        findAndReplaceSimpleElement(innerCount, root, "name", value.getName(), null);
        findAndReplaceSimpleElement(innerCount, root, "url", value.getUrl(), null);
     ...
     * @param root The parent element
     */
    private void updateMailingList(MailingList value, Maven4JDOMWriter.Counter counter, Element root) {
        Maven4JDOMWriter.Counter innerCount = counter.newNextDepthLevelCounter();
        findAndReplaceSimpleElement(innerCount, root, "name", value.getName(), null);
     ...
     * @param root The parent element
     */
    private void updateModel(Model value, Maven4JDOMWriter.Counter counter, Element root) {
        Maven4JDOMWriter.Counter innerCount = counter.newNextDepthLevelCounter();
     ...
     * @param counter The counter
     */
    private void updateNotifier(Notifier value, Maven4JDOMWriter.Counter counter, Element root) {
        Maven4JDOMWriter.Counter innerCount = counter.newNextDepthLevelCounter();
     ...
     * @param element The parent element
     */
    private void updateOrganization(Organization value, Maven4JDOMWriter.Counter counter, Element element) {
        boolean shouldExist = value != null;
     ...
     * @param element The parent element
     */
    private void updateParent(Parent value, Maven4JDOMWriter.Counter counter, Element element) {
        boolean shouldExist = value != null;
     ...
     * @param root The parent element
     */
    private void updatePlugin(Plugin value, Maven4JDOMWriter.Counter counter, Element root) {
        Maven4JDOMWriter.Counter innerCount = counter.newNextDepthLevelCounter();
     ...
     * @param root The parent element
     */
    private void updatePluginExecution(PluginExecution value, Maven4JDOMWriter.Counter counter, Element root) {
        Maven4JDOMWriter.Counter innerCount = counter.newNextDepthLevelCounter();
     ...
     * @param element The parent element
     */
    private void updatePluginManagement(PluginManagement value, Maven4JDOMWriter.Counter counter, Element element) {
        boolean shouldExist = value != null;
     ...
     * @param element The parent element
     */
    private void updatePrerequisites(Prerequisites value, Maven4JDOMWriter.Counter counter, Element element) {
        boolean shouldExist = value != null;
     ...
     * @param root The parent element
     */
    private void updateProfile(Profile value, Maven4JDOMWriter.Counter counter, Element root) {
        Maven4JDOMWriter.Counter innerCount = counter.newNextDepthLevelCounter();
        findAndReplaceSimpleElement(innerCount, root, "id", value.getId(), null);
     ...
     * @param element The parent element
     */
    private void updateRelocation(Relocation value, Maven4JDOMWriter.Counter counter, Element element) {
        boolean shouldExist = value != null;
     ...
     * @param element The parent element
     */
    private void updateReporting(Reporting value, Maven4JDOMWriter.Counter counter, Element element) {
        boolean shouldExist = value != null;
     ...
     * @param counter The counter
     */
    private void updateReportPlugin(ReportPlugin value, Maven4JDOMWriter.Counter counter, Element root) {
        Maven4JDOMWriter.Counter innerCount = counter.newNextDepthLevelCounter();
        findAndReplaceSimpleElement(innerCount, root, "groupId", value.getGroupId(), "org.apache.maven.plugins");
        findAndReplaceSimpleElement(innerCount, root, "artifactId", value.getArtifactId(), null);
        findAndReplaceSimpleElement(innerCount, root, "version", value.getVersion(), null);
     ...
     * @param root The parent element
     */
    private void updateReportSet(ReportSet value, Maven4JDOMWriter.Counter counter, Element root) {
        Maven4JDOMWriter.Counter innerCount = counter.newNextDepthLevelCounter();
        findAndReplaceSimpleElement(innerCount, root, "id", value.getId(), "default");
     ...
     * @param root The parent element
     */
    private void updateRepository(Repository value, Maven4JDOMWriter.Counter counter, Element root) {
        Maven4JDOMWriter.Counter innerCount = counter.newNextDepthLevelCounter();
        updateRepositoryPolicy(value.getReleases(), "releases", innerCount, root);
        updateRepositoryPolicy(value.getSnapshots(), "snapshots", innerCount, root);
        findAndReplaceSimpleElement(innerCount, root, "id", value.getId(), null);
     ...
     * @param counter The counter
     */
    private void updateRepositoryPolicy(RepositoryPolicy value, String xmlTag, Maven4JDOMWriter.Counter counter,
            Element element) {
        boolean shouldExist = value != null;
        Element root = updateElement(counter, element, xmlTag, shouldExist);
        if (shouldExist) {
     ...
     * @param root The parent element
     */
    private void updateResource(Resource value, Maven4JDOMWriter.Counter counter, Element root) {
        Maven4JDOMWriter.Counter innerCount = counter.newNextDepthLevelCounter();
     ...
     * @param element The parent element
     */
    private void updateScm(Scm value, Maven4JDOMWriter.Counter counter, Element element) {
        boolean shouldExist = value != null;
     ...
     * @param element The parent element
     */
    private void updateSite(Site value, Maven4JDOMWriter.Counter counter, Element element) {
        boolean shouldExist = value != null;
    ...
    private static final class Counter {
        ...
        public static Maven4JDOMWriter.Counter initialCounter() {
            return new Maven4JDOMWriter.Counter(0);
        }
         ...
         */
        public Maven4JDOMWriter.Counter newNextDepthLevelCounter() {
            return new Maven4JDOMWriter.Counter(getDepth() + 1);
        }
    }
}
